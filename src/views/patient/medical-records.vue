...
<template>
  <div class="flex flex-col gap-4">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-xl font-semibold text-clinic-900">My Medical Records</h1>
        <p class="text-sm text-gray-500">Your complete health history</p>
      </div>
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
      <Table
        :getAPI="getAPI"
        endpoint-url="/patient/medicalrecords"        :fields="fields"
    ...
    <Modal v-model="modalOpen" :title="detail?.rel_doctor_id ?? 'Record Detail'">
